...
<body class="text-gray-800 font-inter">
    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
        ...
        <ul class="mt-4">
            ...
            <li class="mb-1 group">
            <a href="TeacherCourses.php" class="flex font-semibold items-center py-2 px-4 text-gray-900 bg-gray-950 text-white rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 sidebar-dropdown-toggle">
    ...
    <div class="absolute inset-0 flex flex-col justify-end p-4 sm:p-6 lg:p-8 bg-black/30 backdrop-blur-sm">
      <div class="space-y-2 sm:space-y-3 text-center sm:text-left">
        ...
        <p class="hidden sm:block text-white text-sm sm:text-base md:text-lg opacity-90">
          ...
          <?php
                $CategoryName = Category::getCategoryById($conn, $course->getIdCategory());
                echo $CategoryName;
                ?>
          </span>
        </p>
